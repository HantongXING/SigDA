...
for epoch in range(1600):  
    ...
    if precision > precesion_previous:
        ...
        torch.save(model, '/data/xht/modulation_recog/open-source-code/comparative_experiment/checkpoints/vgg2.pth')
...
############################# Testing #############################################
net = torch.load('/data/xht/modulation_recog/open-source-code/comparative_experiment/checkpoints/vgg2.pth')
net.eval()
correct = 0
fals = 0
cmt = torch.zeros(11, 11, 20, dtype=torch.int16)
